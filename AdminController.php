...
class AdminController extends BaseController
{
    ...
    public function doSignUp()
    {
        $rules = array(
            ...
            //'username' => 'required|alphaNum|min:2|unique:tbl_vast_users',  /*commented on 31.05.2018*/
			'username' => 'required|alpha_dash|min:2|regex:/^[a-z0-9_\-]+$/|unique:tbl_vast_users',
            'password' => 'required|alphaNum|min:3',
        ...
        if ($validator->fails()) {
            ...
            Util::sendSESMail('admin@thefutureisvast.us', Input::get('email_id'), 'Registration successful', null, $html_body);
  ...
  <a href="' . $url . '">Reset My Password </a> </p>
                ...
                Util::sendSESMail('admin@thefutureisvast.us', $user['email_id'], 'Reset your Vast Password', null, $html_body);
    ...
    public function doResetPassword()
    {
        ...
        if ($validator->fails()) {
            ...
            if ($user && $user->email_id != '') {
                ...
                Util::sendSESMail('admin@thefutureisvast.us', $user['email_id'], 'Your VAST password has been reset.', null, $html_body);
    ...
    public function addPost()
    {
        ...
        $response     = $sts->assumeRole(array(
            'RoleArn' => 'arn:aws:iam::776400555584:role/vast-role',
            #'RoleArn' => 'arn:aws:iam::776400555584:role/WebServer',
    ...
    public function doUpdateAdminUserDetails()
    {
        ...
        $rules = array(
			...
			'username' => 'required|alpha_dash|min:3|unique:tbl_vast_users,username,' . $edit_id . ',vast_user_id',
        ...
        if ($validator->fails()) {
            ...
            if (Input::get('status') == '1' && $user['status'] == '0') { #  User been activated from pending approval
                ...
                Util::sendSESMail('admin@thefutureisvast.us', $user['email_id'], 'Your account has been activated', null, $html_body);
            }
    ...
    {
	Log::info("Calling doVideoConversion()");
		...
		Log::info("videoStatus == 1 && secVideoStatus == 1");
				...
				Log::info("Start updating S3 json files");
				App::make('AjaxController')->updateAdvastJsonData($pendingConversion['channel_id']);
				Log::info("Finished Updating S3 json files");
                ...
                if($res == 1){
		    Log::info("Deleting post id from conversion table");
	...
	*/
	...
	public function resizeImage(){
        $imgUrl  = "http://s3.amazonaws.com/vast-production/postimages/retina/thebridgeco1474551071.JPG";
